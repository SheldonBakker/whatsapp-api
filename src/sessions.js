const { Client } = require('whatsapp-web.js') // LocalAuth is handled within generateClientOptions
const fs = require('fs')
...
const { safeKillBrowser, generateClientOptions } = require('./utils/puppeteerManager') // Import puppeteer utils
const { initializeEvents } = require('./utils/sessionEventHandler') // Import event handler
